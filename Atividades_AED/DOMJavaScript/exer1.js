window.onload = function onloadq1(){
	let exer1 = document.getElementById('exer1');
	exer1.innerHTML = "<label>Valor minimo = 1 | valor maximo = 50</label> </br>"
	...
	let exer2 = document.getElementById('exer2');
	exer2.innerHTML = "<label>Valor minimo = 1 | valor maximo = 12</label> </br>"
	...
	let exer4 = document.getElementById('exer4');
	exer4.innerHTML = "<label>Valor minimo = 1 | valor maximo = 50</label> </br>"
	...
	let exer5 = document.getElementById('exer5');
	exer5.innerHTML = "<label>Digite o valor dos lados do triangulo</label> </br>"
	...
	let exer6 = document.getElementById('exer6');
	exer6.innerHTML = ' <h1>login</h1> 	<div id="nao_logado"> <input id="username" type="text"> '
